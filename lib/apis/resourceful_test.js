...
describe('Resource', function () {
	...
	describe('Registering formatters', function() {
		var testResource;
		...
		it('should allow default formatter', function () {
			testResource.format(function (e) {
				return 'bar';
			});
		...
		it('should allow adding named formatters', function () {
			var defaultEntity = {
				a: 1
			};
