...
function makeResource(_name, relPath) {
	...
	var newResource = function (type, entity) {
		var resource;
		...
		resource = (_models[type] && _models[type](entity)) || entity;

		if (_strategies[type]) {
			return _strategies[type].call(newResource, resource);
		}
	...
	newResource.use = fluent(function (type, strategy) {
	...
	newResource.model = fluent(function (type, fn) {
		if (typeof type === 'function') {
			fn = type;
			type = 'default';
		}
